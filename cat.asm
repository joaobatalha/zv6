...
cat(int fd)
{
  ...
  47:	68 4c 08 00 00       	push   $0x84c
  4c:	6a 01                	push   $0x1
  4e:	e8 51 04 00 00       	call   4a4 <printf>
...
main(int argc, char *argv[])
{
  ...
  c1:	50                   	push   %eax
  c2:	68 5d 08 00 00       	push   $0x85d
  c7:	6a 01                	push   $0x1
  c9:	e8 d6 03 00 00       	call   4a4 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 440:	8a 90 7c 08 00 00    	mov    0x87c(%eax),%dl
...
printf(int fd, char *fmt, ...)
{
 ...
 57c:	75 25                	jne    5a3 <printf+0xff>
          s = "(null)";
 57e:	c7 45 f4 72 08 00 00 	movl   $0x872,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 643:	a1 a8 08 00 00       	mov    0x8a8,%eax
...
free(void *ap)
{
 ...
 704:	a3 a8 08 00 00       	mov    %eax,0x8a8
}
 709:	c9                   	leave  
 70a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 761:	83 c4 10             	add    $0x10,%esp
  return freep;
 764:	a1 a8 08 00 00       	mov    0x8a8,%eax
}
 769:	c9                   	leave  
 76a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 77b:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 77e:	a1 a8 08 00 00       	mov    0x8a8,%eax
 783:	89 45 f0             	mov    %eax,-0x10(%ebp)
 786:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 78a:	75 23                	jne    7af <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 78c:	c7 45 f0 a0 08 00 00 	movl   $0x8a0,-0x10(%ebp)
 793:	8b 45 f0             	mov    -0x10(%ebp),%eax
 796:	a3 a8 08 00 00       	mov    %eax,0x8a8
 79b:	a1 a8 08 00 00       	mov    0x8a8,%eax
 7a0:	a3 a0 08 00 00       	mov    %eax,0x8a0
    base.s.size = 0;
 7a5:	c7 05 a4 08 00 00 00 	movl   $0x0,0x8a4
 7ac:	00 00 00 
  }
 ...
 802:	a3 a8 08 00 00       	mov    %eax,0x8a8
      return (void*)(p + 1);
 ...
 80d:	eb 3b                	jmp    84a <malloc+0xdf>
    ...
    if(p == freep)
 80f:	a1 a8 08 00 00       	mov    0x8a8,%eax
