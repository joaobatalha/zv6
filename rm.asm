...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c0:	8a 90 00 08 00 00    	mov    0x800(%eax),%dl
...
printf(int fd, char *fmt, ...)
{
 ...
 4fc:	75 25                	jne    523 <printf+0xff>
          s = "(null)";
 4fe:	c7 45 f4 f9 07 00 00 	movl   $0x7f9,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c3:	a1 1c 08 00 00       	mov    0x81c,%eax
...
free(void *ap)
{
 ...
 684:	a3 1c 08 00 00       	mov    %eax,0x81c
}
 689:	c9                   	leave  
 68a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 6e1:	83 c4 10             	add    $0x10,%esp
  return freep;
 6e4:	a1 1c 08 00 00       	mov    0x81c,%eax
}
 6e9:	c9                   	leave  
 6ea:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 6fb:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 6fe:	a1 1c 08 00 00       	mov    0x81c,%eax
 703:	89 45 f0             	mov    %eax,-0x10(%ebp)
 706:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 70a:	75 23                	jne    72f <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 70c:	c7 45 f0 14 08 00 00 	movl   $0x814,-0x10(%ebp)
 713:	8b 45 f0             	mov    -0x10(%ebp),%eax
 716:	a3 1c 08 00 00       	mov    %eax,0x81c
 71b:	a1 1c 08 00 00       	mov    0x81c,%eax
 720:	a3 14 08 00 00       	mov    %eax,0x814
    base.s.size = 0;
 725:	c7 05 18 08 00 00 00 	movl   $0x0,0x818
 72c:	00 00 00 
  }
 ...
 782:	a3 1c 08 00 00       	mov    %eax,0x81c
      return (void*)(p + 1);
 ...
 78d:	eb 3b                	jmp    7ca <malloc+0xdf>
    ...
    if(p == freep)
 78f:	a1 1c 08 00 00       	mov    0x81c,%eax
